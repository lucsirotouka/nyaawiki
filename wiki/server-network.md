...
* 世界列表：
 + `v0` - 1.11 / 原 M 世界
 + `v1` - 1.11.2
* 无任何特殊权限和权限组（因此在生存服务器即便看到 [喵喵喵] 的前缀也未必是管理组成员哦）；
* 无任何规划；
* 请遵守喵窝的通用守则。
...
*   如用地发生冲突，请自行协商合作。
*   详细规则见[NyaaBBS帖子<sup>（存档截图）</sup>](/assets/images/legacy/nyaabbs/1375-freebuild.webp ':ignore')。
*   ~~同时对毛玉线圈物语开放。~~
...
!> 此服务器后来作为[一个维度](nyaa/worlds#无尽地狱世界)并入喵窝世界。
